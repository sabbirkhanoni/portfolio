...
export function Blacksky(props) {
  const { nodes, materials } = useGLTF('/src/assets/night_sky_visible_spectrum_monochromatic.glb')
  return (
...
useGLTF.preload('/src/assets/night_sky_visible_spectrum_monochromatic.glb')
